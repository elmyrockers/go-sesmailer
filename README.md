...
```
> Make sure you have your AWS credentials set in the environment variables (***AWS_ACCESS_KEY_ID***, ***AWS_REGION*** and ***AWS_SECRET_ACCESS_KEY***) or through your AWS config.
